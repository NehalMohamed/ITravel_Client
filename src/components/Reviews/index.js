...
const Reviews = ({ tripData, refreshTripDetails }) => {
  ...
  const { reviewsByTrip, loading, error, submission } = useSelector(
    (state) => state.reviews
  );
  ...
  useEffect(() => {
    if (submission.error) {
      setPopupMessage(
        submission.error.message || t("tripDetails.reviewSubmissionError")
      );
      setPopupType("alert");
      setShowPopup(true);
  ...
  const AllReviewsModal = () => (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title className="review-header">
          {t("tripDetails.allReviews")}
        </Modal.Title>
      </Modal.Header>
            ...
            <div className="col-lg-10">
              <div className="reviews-container">
                <h3 className="section-title">
                  {t("tripDetails.reviewsFromTravelers")}
                </h3>
                    ...
                    <div className="rating-section mb-3">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <span className="ms-2 rating-value mb-3">
                          {userRating > 0
                            ? `${userRating} ${t("tripDetails.stars")}`
                            : t("tripDetails.notRated")}
                        </span>
                      </div>
                    </div>
